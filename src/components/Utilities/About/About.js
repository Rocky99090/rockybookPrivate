                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12">
                        <div className="about-content s-about-content wow fadeInRight" data-wow-delay=".4s">
                            ...
                            <p>Welcome to RockyBook - the best betting site in India. At RockyBook, we provide a diverse array of betting options, including sportsbooks, live cards, and live casinos.</p>
